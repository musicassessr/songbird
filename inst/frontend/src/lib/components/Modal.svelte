<script>
    ...
    const handleFormSubmit = (event) => {
        ...
        if (agreeRecording && agreeParticipation) {
            dispatch("confirm", {
                text: "true",
            });
            closeModal();
    ...
    <div class="modal-background" on:click={closeModal}>
        <div class="modal-content" on:click|stopPropagation>
            {#if showContent === "main"}
                ...
                <br />
                <p>
                    Mein Kind und ich sind schriftlich im ausreichenden Maße
                    über das Ziel und den Ablauf der Studie informiert worden
                    und haben die Informationen zur <span
                        class="underline"
                    ...
                    <span class="underline" on:click={showDatenschutz}>
                        Datenschutz
                    </span>. erhalten. Mit der beschriebenen Erhebung und
                ...
                <form on:submit={handleFormSubmit}>
                    ...
                    <div class="checkbox-container">
                        ...
                        <label for="agreeParticipation">
                            Ich willige ein, dass mein Kind an der Studie
                            teilnehmen und die App SongBird nutzen darf.
                        </label>
                    </div>
            ...
            {#if showContent === "freiwilligkeit"}
                ...
                >
                <h2 class="header" style="text-align: left;">
                    Freiwilligkeit:
                </h2>
                <p>
                    Die Teilnahme an der Studie ist freiwillig. Sie bzw. Ihre
                    ...
                    werden. Bitte erläutern Sie, was die Probanden tun müssen.
                </p>
            {/if}
            ...
            {#if showContent === "datenschutz"}
                ...
                <p>
                    Die Erhebung aller Daten erfolgt vollständig anonymisiert,
